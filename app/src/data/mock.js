...
export const reels = [
  { id: 31, user: 'maya_sky', emoji: '🌅', grad: ['#12324a', '#2a0f2e'], caption: 'Golden hour on the rooftop 🌅✨', likes: '1.2k', comments: '84', following: true },
  ...
  { id: 33, user: 'coffee.aisha', emoji: '☕', grad: ['#3a2718', '#241533'], caption: 'Slow mornings ☕📖', likes: '892', comments: '46', following: true },
]
...
export const me = {
  ...
  photos: ['🧑🏻', '🏖️', '🎸'],
  prefs: { ageRange: '22 – 32', distance: '50 km' },
}
